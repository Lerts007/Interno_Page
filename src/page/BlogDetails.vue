...
.content-quote {
  ...
  border-radius: 50px;
  & p:first-child {
    @include DMSerifDisplay150ItalicColorCDA274;
    margin-top: -75px;
  }
  & p:last-child {
    @include DMSerifDisplay25ItalicColorCDA274;
    margin-top: -5px;
  }
}
.blogDetails-content__list {
  @include DMSerifDisplay20;
  margin-top: 20px;
  margin-bottom: 42px;
...
.tags-main-block {
  ...
  padding: 6px 31px;
  border-radius: 10px;
  background-color: $backgroundSectionCounter;
  cursor: pointer;
}
